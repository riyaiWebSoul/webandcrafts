    ...
    [3015],
    {
        ...
        83015: function (e, t, n) {
            ...
            let r = n(21024),
                ...
                y = (e) => {
                    let { src: t, id: n, onLoad: r = () => {}, onReady: l = null, dangerouslySetInnerHTML: a, children: o = "", strategy: i = "afterInteractive", onError: c, stylesheets: y } = e,
                        h = n || t;
                    if (h && s.has(h)) return;
                    if (d.has(t)) {
                        s.add(h), d.get(t).then(r, c);
                        return;
                    }
                    let m = () => {
                            l && l(), s.add(h);
                    ...
                    for (let [n, r] of (a ? ((_.innerHTML = a.__html || ""), m()) : o ? ((_.textContent = "string" == typeof o ? o : Array.isArray(o) ? o.join("") : ""), m()) : t && ((_.src = t), d.set(t, b)), Object.entries(e))) {
                        if (void 0 === r || f.includes(n)) continue;
                        let e = u.DOMAttributeNames[n] || n.toLowerCase();
                        _.setAttribute(e, r);
                    }
                    "worker" === i && _.setAttribute("type", "text/partytown"), _.setAttribute("data-nscript", i), y && p(y), document.body.appendChild(_);
                };
            function h(e) {
            ...
            function _(e) {
                let { id: t, src: n = "", onLoad: r = () => {}, onReady: l = null, strategy: u = "afterInteractive", onError: d, stylesheets: f, ...p } = e,
                    { updateScripts: h, scripts: m, getIsSsr: _, appDir: b, nonce: g } = (0, o.useContext)(i.HeadManagerContext),
                    v = (0, o.useRef)(!1);
                (0, o.useEffect)(() => {
                    let e = t || n;
                ...
                if (
                    ...
                    ("beforeInteractive" === u || "worker" === u) && (h ? ((m[u] = (m[u] || []).concat([{ id: t, src: n, onLoad: r, onReady: l, onError: d, ...p }])), h(m)) : _ && _() ? s.add(t || n) : _ && !_() && y(e)),
                    b)
                ) {
                    if (
                        (f &&
                        ...
                        return n
                            ? (a.default.preload(n, p.integrity ? { as: "script", integrity: p.integrity } : { as: "script" }),
                              o.default.createElement("script", { nonce: g, dangerouslySetInnerHTML: { __html: "(self.__next_s=self.__next_s||[]).push(" + JSON.stringify([n]) + ")" } }))
                            : (p.dangerouslySetInnerHTML && ((p.children = p.dangerouslySetInnerHTML.__html), delete p.dangerouslySetInnerHTML),
                              o.default.createElement("script", { nonce: g, dangerouslySetInnerHTML: { __html: "(self.__next_s=self.__next_s||[]).push(" + JSON.stringify([0, { ...p }]) + ")" } }));
                    "afterInteractive" === u && n && a.default.preload(n, p.integrity ? { as: "script", integrity: p.integrity } : { as: "script" });
                }
                return null;
            }
