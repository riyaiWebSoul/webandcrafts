...
// Import any necessary CSS or CSS modules

const Footer = () => {
  return (
    <footer className="footer_footer__EieGz bg-dark">
      <div className="container">
        <div className="footer_footer_inner__b4GIZ">
          <div className="footer_enquire_wrapper__TvnBp row">
            ...
            <div className="footer_action__hHR8y col-md-4 d-flex items-start mt-2">
              <a className="btn btn-primary light" href="/contact-us/get-quote">
          ...
          <div className="footer_quick_links__UkFDF">
            <div className="row">
          ...
          <div className="footer_copyright_details__ZCvfR">
            <div className="row">
              <div className="col-lg d-flex footer_copy_right_wrapper__0pkMy">
                <p className="mb-0 me-md-4  footer_copyright_text__cE1o_">
                  WAC © 2023 All rights reserved
                </p>
                <p className="mb-0 ms-md-4">
                  <a className="footer_link__jfCKV" href="/privacy-policy">
                    Privacy Policy
                  </a>
                  <span className="footer_divider__ZoFyS">|</span>
                  <a
                    className="footer_link__jfCKV"
              ...
              <div className="w-auto">
                <ul className="footer_social_media_wrapper__qDuls d-flex p-0">
                  <li>
                    <a
                      target="_blank"
